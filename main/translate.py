...
tail_names = {
    "-a": ["-a", "Hayrat yuklamasi"],
    "-chi": ["-chi", "Soʻroq yuklamasi"],
    "-da": ["-da", "Taʼkid yuklamasi"],
    "-ku": ["-ku", "Soʻroq yuklamasi"],
    "-u": ["-u", "Zidlash yuklamasi"],
    "-ya": ["-ya", "Hayrat yuklamasi"],
    "-yu": ["-yu", "Zidlash yuYuklamasi"],
    "a": ["a", "Kelgusi zamon"],
    "u": ["u", "Kelgusi zamon (k.)"],
    "b": ["b", "Ravishdosh"],
    "cha": ["cha", "Qiyoslash"],
    "chalik": ["chalik", "Chegara"],
    "da": ["da", "Oʻrin-payt"],
    "dagi": ["dagi", "Joylashuv"],
    "dan": ["dan", "Chiqish"],
    "day": ["day", "Oʻxshatish"],
    ...
    "deg": ["dek", "Oʻxshatish"],
    "di": ["di", "Oʻtgan zamon"],
    "digan": ["digan", "Sifatdosh"],
    "dir": ["dir", "Urgʻu yuklamasi"],
    "dur": ["dur", "Urgʻu yuklamasi (k.)"],
    "ga": ["ga", "Joʻnalish"],
    "gach": ["gach", "Tugallanish"],
    "gacha": ["gacha", "Muddat"],
    "gan": ["gan", "Sifatdosh"],
    "gay": ["gay", "Kelgusi zamon (k.)"],
    "gi": ["gi", "Istak mayli"],
    "gin": ["gin", "Buyruq mayli"],
    "gina": ["gina", "Ayirish / erkalash"],
    "gu": ["gu", "Qiyoslash"],
    "gun": ["gun", "Muddat"],
    "gur": ["gur", "Tilak mayli"],
    "guvchi": ["guvchi", "Sifatdosh"],
    "i": ["i", "3-sh. birlik"],
    "ib": ["ib", "Ravishdosh"],
    "im": ["im", "1-sh. birlik"],
    "imiz": ["imiz", "1-sh. koʻplik"],
    "in": ["in", "Kuchaytirish (k.)"],
    "ing": ["ing", "2-sh. birlik"],
    "ingiz": ["ingiz", "2-sh. koʻplik"],
    "ish": ["ish", "Harakat nomi"],
    "jak": ["jak", "Kelgusi zamon (k.)"],
    "jag": ["jak", "Kelgusi zamon (k.)"],
    "k": ["k", "1-sh. koʻplik"],
    "g": ["k", "1-sh. koʻplik"],
    "kan": ["kan", "[ekan]"],
    "ki": ["ki", "Taʼkid yuklamasi"],
    "lar": ["lar", "Koʻplik / hurmat / mubolagʻa"],
    "lik": ["lik", "Mavhumlik"],
    "lig": ["lik", "Mavhumlik"],
    "m": ["m", "1-sh. birlik"],
    "ma": ["ma", "Inkor shakl"],
    "man": ["man", "1-sh. birlik kesim"],
    "mas": ["mas", "Inkor shakl"],
    "mi": ["mi", "Soʻroq yuklamasi"],
    "mish": ["mish", "Taxmin yuklamasi"],
    "miz": ["miz", "1-sh. koʻplik kesim"],
    "moq": ["moq", "Harakat nomi"],
    "mogʻ": ["moq", "Harakat nomi"],
    "moqchi": ["moqchi", "Maqsad mayli"],
    "moqda": ["moqda", "Hozirgi zamon (k.)"],
    "ng": ["ng", "2-sh. birlik"],
    "ngiz": ["ngiz", "2-sh. koʻplik"],
    "ni": ["ni", "Tushum"],
    "niki": ["niki", "Tegishlilik"],
    "ning": ["ning", "Qaratqich"],
    "ol": ["ol", "[olmoq]"],
    "oq": ["oq", "Darhollik yuklamasi"],
    "ov": ["ov", "Gumon yuklamasi"],
    "qol": ["qol", "[qolmoq]"],
    "r": ["r", "Kelgusi zamon gumon"],
    "roq": ["roq", "Qiyosiy daraja"],
    "rogʻ": ["roq", "Qiyosiy daraja"],
    "s": ["s", "Ravishdosh (inkor)"],
    "sa": ["sa", "Shart mayli"],
    "san": ["san", "2-sh. birlik kesim"],
    "si": ["si", "3-sh. birlik"],
    "sin": ["sin", "Buyruq mayli"],
    "siz": ["siz", "2-sh. koʻplik kesim / mahrumlik"],
    "ti": ["ti", "[yapti]"],
    "uv": ["uv", "Harakat nomi"],
    "uvchi": ["uvchi", "Sifatdosh"],
    "ver": ["ver", "[bermoq]"],
    "y": ["y", "Kelgusi zamon"],
    "yap": ["yap", "Hozirgi zamon"],
    "yoq": ["yoq", "Darhollik yuklamasi"],
    "yot": ["yot", "Davomiylik"],
    "yotib": ["yotib", "Ravishdosh"],
    "yotir": ["yotir", "Davomiylik (k.)"],
...
complex_words = [
    ...
    "baloyi xudo",
    "bardor-bardor qil",
    "bardor-bardor qildir",
    "bardor-bardor qilin",
    "bardor-bardor qilish",
    "barham ber",
    "barham beril",
    "barham berish",
    "barham top",
    ...
    "ekvatorli gvineya",
    "el salvador",
    "enka-tinkasini chiqair",
    "enka-tinkasini chiqairsh",
    "enka-tinkasini qurit",
    "enka-tinkasini quritish",
    "epaqaga kel",
    "epaqaga keltir",
    "epaqaga keltiril",
    "epaqaga keltirish",
    ...
    "fikr-u xayol",
    "fil suyak sohili",
    "gʻarra-sharra sarf qil",
    "gʻarra-sharra sarf qilin",
    "gʻarra-sharra sarf qilish",
    "gʻingʻ-gʻingʻ qil",
    "gʻingʻ-gʻingʻ qildir",
    "gʻingʻ-gʻingʻ qildirish",
    "gʻingʻ-gʻingʻ qilish",
    "gʻingʻir-gʻingʻir qil",
    "gʻingʻir-gʻingʻir qilish",
    "gʻippa boʻgʻ",
    "gʻippa boʻgʻil",
    "gʻippa boʻgʻish",
    "gʻiring de",
    ...
    "janubiy sudan",
    "javdir-javdir boq",
    "javdir-javdir boqish",
    "javdir-javdir qara",
    "javdir-javdir qarash",
    "jon-u dil",
    "jon-u jahon",
    "jon-u tan",
    "kabo verde",
    ...
    "kvadrat-uyalab ek",
    "kvadrat-uyalab ekil",
    "kvadrat-uyalab ekish",
    "kvadrat-uyalab ektir",
    "kvadrat-uyalab ektiril",
    "kvadrat-uyalab ektirish",
    "lof-qof ur",
    "lof-qof urish",
    "mahv boʻl",
    "mahv boʻlish",
    ...
    "yosh-u qari",
    "yumma-yumma yigʻla",
    "yumma-yumma yigʻlash",
    "yumma-yumma yigʻlat",
    "zikr-u samo",
    "zoʻrma-zoʻrakilik bilan",
    "zudlik bilan",
    "ilmiy-tadqiqot",
...
def translate_to_cyrillic(text):
    ...
    text = re.sub("\\[Ь\\]([^\\w])|\\[Ь\\]$", "Ь\\1", text)
    text = re.sub(
        "^E|([^БВГДЕЁЖЗИЙКЛМНПРСТФХЦЧШЪЫЬЭЮЯЎҚҒҲбвгдеёжзийклмнпрстфхцчшъыьэюяўқғҳ])E|([\\s+])E", "\\1\\2Э", text
    )
    text = re.sub(
        "^e|([^БВГДЕЁЖЗИЙКЛМНПРСТФХЦЧШЪЫЬЭЮЯЎҚҒҲбвгдеёжзийклмнпрстфхцчшъыьэюяўқғҳ])e|([\\s+])e", "\\1\\2э", text
    )
    ...
    text = re.sub(
        "(\\d+)-(январ|феврал|март|апрел|май|июн|июл|август|сентябр|октябр|ноябр|декабр"
    ...
    text = re.sub(
        "([^БВГДЕЁЖЗИЙКЛМНПРСТФХЦЧШЪЫЬЭЮЯЎҚҒҲбвгдеёжзийклмнпрстфхцчшъыьэюяўқғҳ])"
        + "Яна-да([^БВГДЕЁЖЗИЙКЛМНПРСТФХЦЧШЪЫЬЭЮЯЎҚҒҲбвгдеёжзийклмнпрстфхцчшъыьэюяўқғҳ])",
        "\\1Янада\\2",
        text,
    )
    text = re.sub(
        "([^БВГДЕЁЖЗИЙКЛМНПРСТФХЦЧШЪЫЬЭЮЯЎҚҒҲбвгдеёжзийклмнпрстфхцчшъыьэюяўқғҳ])яна-да(["
        "^БВГДЕЁЖЗИЙКЛМНПРСТФХЦЧШЪЫЬЭЮЯЎҚҒҲбвгдеёжзийклмнпрстфхцчшъыьэюяўқғҳ])",
        "\\1янада\\2",
        text,
    )
...
def translate_to_latin(text):
    ...
    text = re.sub(
        "(\\d+)\\s+(yanvar|fevral|mart|aprel|may|iyun|iyul|avgust|sentyabr|oktyabr|noyabr|dekabr|"
...
def generate_field(field):
    try:
        result = translate_to_latin(field)
        return result
    except Exception:
        pass
